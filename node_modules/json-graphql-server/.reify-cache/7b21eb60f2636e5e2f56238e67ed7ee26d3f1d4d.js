"use strict";var GraphQLBoolean,GraphQLFloat,GraphQLID,GraphQLInt,GraphQLList,GraphQLNonNull,GraphQLString;module.watch(require('graphql'),{GraphQLBoolean(v){GraphQLBoolean=v},GraphQLFloat(v){GraphQLFloat=v},GraphQLID(v){GraphQLID=v},GraphQLInt(v){GraphQLInt=v},GraphQLList(v){GraphQLList=v},GraphQLNonNull(v){GraphQLNonNull=v},GraphQLString(v){GraphQLString=v}},0);var GraphQLJSON;module.watch(require('graphql-type-json'),{default(v){GraphQLJSON=v}},1);var DateType;module.watch(require('./DateType'),{default(v){DateType=v}},2);
...
module.exportDefault((name, values = [], isRequired = false) => {

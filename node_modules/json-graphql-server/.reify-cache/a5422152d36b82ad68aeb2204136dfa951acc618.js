"use strict";module.export({getRelationshipFromKey:()=>getRelationshipFromKey,getTypeFromKey:()=>getTypeFromKey,getRelatedKey:()=>getRelatedKey,getReverseRelatedField:()=>getReverseRelatedField,getRelatedType:()=>getRelatedType},true);var camelize,pluralize,singularize;module.watch(require('inflection'),{camelize(v){camelize=v},pluralize(v){pluralize=v},singularize(v){singularize=v}},0);

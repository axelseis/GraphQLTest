"use strict";var getTypeFromValues;module.watch(require('./getTypeFromValues'),{default(v){getTypeFromValues=v}},0);var getValuesFromEntities;module.watch(require('./getValuesFromEntities'),{default(v){getValuesFromEntities=v}},1);
 ...
 * // };
 */
module.exportDefault((entities, checkRequired = true) => {

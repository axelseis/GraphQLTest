"use strict";var getFieldsFromEntities;module.watch(require('../../introspection/getFieldsFromEntities'),{default(v){getFieldsFromEntities=v}},0);var getRelatedKey,getRelatedType,getRelationshipFromKey,getReverseRelatedField;module.watch(require('../../nameConverter'),{getRelatedKey(v){getRelatedKey=v},getRelatedType(v){getRelatedType=v},getRelationshipFromKey(v){getRelationshipFromKey=v},getReverseRelatedField(v){getReverseRelatedField=v}},1);var isRelationshipField;module.watch(require('../../relationships'),{isRelationshipField(v){isRelationshipField=v}},2);
 ...
 *     }
 */
module.exportDefault((entityName, data) => {
